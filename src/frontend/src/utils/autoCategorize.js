...
const CATEGORY_KEYWORDS = {
  ...
  'hoa-kieng': {
    main: ['hoa', 'kiểng', 'hoa kiểng', 'flower'],
    subcategories: {
  ...
  'phu-kien': {
    main: ['phụ kiện', 'phu kien', 'accessory', 'decor', 'trang trí'],
    subcategories: {
      'phan-bon': ['phân bón', 'phan bon', 'fertilizer', 'phân'],
      'dat-trong': ['đất trồng', 'dat trong', 'soil', 'potting mix', 'đất trồng cây'],
      'dung-cu': ['dụng cụ', 'dung cu', 'garden tools', 'tool']
    }
  }
}
